...
<div class="container">
    ...
    ?>
    <div class="table-scrol" style="background: white; margin-top:10px; margin-bottom: 10px; padding-top: 10px; padding-bottom: 10px;" >  
     <div class="table-responsive"><!--this is used for responsive display in mobile and other devices-->  
            ...
            $view_query="select * from `item` WHERE idesc LIKE 'des%'";//select query for viewing users.  
